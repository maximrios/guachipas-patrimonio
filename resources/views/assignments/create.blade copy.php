                                    ...
                                    <form action="{{ url('assignments/untracked') }}" method="post" id="non-registered-form">
                                        ...
                                        <div id="collapseNonRegistrable" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                                            <div class="panel-body">
                                                ...
                                                <div class="form-group">
                                                    <button id="add-non-registered" class="btn btn-sm btn-success btn-block" type="submit">AGREGAR</button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
...
<script>
    ...
    $(document).ready(function() {
        ...
        //Non registered
        $('#non-registered-form').on('submit', function(event) {
            event.preventDefault();
            var action = $(this).attr('action');
            var data = new FormData( document.getElementById('non-registered-form') );
            console.log(data);
            $.ajax({
                url: action,
                type: 'post',
